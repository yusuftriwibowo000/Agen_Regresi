...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0044_NCS_Multi_Finance.xlsx", "SMAG-0044")
Call spGetDatatable()
...
If dt_TCID = "MAG0044-003" Then 
	Call Choice_Fav()
Else
	Call Input_Baru(dt_TCID, dt_NoKontrak, dt_SaveName)
End If
...
If dt_TCID = "MAG0044-001" or dt_TCID = "MAG0044-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0044-002" Then
