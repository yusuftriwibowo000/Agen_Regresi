...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0004_Informasi_Agen.xlsx", "SMAG-0004")
Call spGetDatatable()
...
If dt_TCID = "MAG0004-001" Then
'    	Call Info_Agen()
Call Verify_CekValue()
ElseIf dt_TCID = "MAG0004-002" Then
'	Call Hide_Unhide_Saldo_Agen()
Call Verify_CekValue()
ElseIf dt_TCID = "MAG0004-003" Then
	Call Lihat_Profile()
End If
Call Logout()
...
Sub spLoadLibrary()
    ...
    REM ---- Informasi Agen Keagenan Mobile Library
	LoadFunctionLibrary (LibPathKeagenanMobile & "Lib_KeagenanMobile_InformasiAgen.qfl")
