REM -- Bayar dan Beli PLN Prepaid
Dim dt_TCID, dt_TestScenarioDesc, dt_ScenarioDesc, dt_ExpectedResult
Dim dt_IDPelanggan, dt_PinTrx, dt_SaveName
Dim dt_Username, dt_Password

REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG0033_PLNPrepaid_n_DaftarFavorite.xlsx", "SMAG-0033")
Call spGetDatatable()
...
If dt_TCID = "MAG0033-003" Then
	Call Choice_Fav()
Else
	Call Input_Baru(dt_TCID, dt_IDPelanggan, dt_SaveName)
End If

If dt_TCID = "MAG0033-007" Then
	Call Verify_Fail()
Else
...
If dt_TCID = "MAG0033-001" or dt_TCID = "MAG0033-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0033-004" or dt_TCID = "MAG0033-005" or dt_TCID = "MAG0033-006" Then
	Call Verify_Fail()
ElseIf dt_TCID = "MAG0033-002" Then
...
Sub spLoadLibrary()
	...
	LoadFunctionLibrary (LibPathKeagenanMobile & "Lib_KeagenanMobile_PLNPrepaid.qfl")
