REM -- Home Page Perkiraan Pendapatan
Dim dt_TCID, dt_TestScenarioDesc, dt_ScenarioDesc, dt_ExpectedResult
Dim dt_Username, dt_Password

REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG0034_Total_Perkiraan_Pendapatan.xlsx", "SMAG-0034")
Call spGetDatatable()
...
If dt_TCID = "MAG0034-001" Then
	Call Verify_CekValue()
ElseIf dt_TCID = "MAG0034-002" Then
	Call Verify_HideUnhide
End If
