...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0060_Multifinance_OTO_Credit.xlsx", "SMAG-0060")
Call spGetDatatable()
...
If dt_TCID = "MAG0060-003" or dt_TCID = "MAG0060-007" Then 
	Call Choice_Fav_OTO()
Else
	Call Input_Baru_Multifinance_OTO_Credit(dt_TCID, dt_NoKontrak, dt_SaveName)
End If

If dt_TCID = "MAG0060-007" or dt_TCID = "MAG0060-008" Then
	Call Verify_Fail()
Else
	Call Input_Pass(dt_TCID, dt_PinTrx)
End If

If dt_TCID = "MAG0060-001" or dt_TCID = "MAG0060-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0060-002" Then
	Call Verify_Success_Save()
ElseIf dt_TCID = "MAG0060-004" Then
	Call Verify_Fail_Password_Kosong()
ElseIf dt_TCID = "MAG0060-005" or dt_TCID = "MAG0060-009" Then
	Call Verify_Fail()
End If
