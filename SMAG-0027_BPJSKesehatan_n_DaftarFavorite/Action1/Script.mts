...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG0027_BPJSKesehatan_n_DaftarFavorite.xlsx", "SMAG-0027")
Call spGetDatatable()

Call fnRunningIterator()
Call spReportInitiate()
Call spAddScenario(dt_TCID, dt_TestScenarioDesc, dt_ScenarioDesc, dt_ExpectedResult, Array("Automation Testing : " & "BAYAR & BELI BPJS Kesehatan & Daftar Favorite"))
...
If dt_TCID = "MAG0027-006" or dt_TCID = "MAG0027-007" Then
	Call Verify_Fail()
Else
...
Sub spLoadLibrary()
	...
	LoadFunctionLibrary (LibPathKeagenanMobile & "Lib_KeagenanMobile_BPJS.qfl")
	Call RepositoriesCollection.Add(LibRepo & "RP_KeagenanMobile_BPJS.tsr")
End Sub
...
Sub spGetDatatable()
	...
	Rem --------- Paket Data
	dt_PayCode	= DataTable.Value("NO_VA", dtLocalSheet)
