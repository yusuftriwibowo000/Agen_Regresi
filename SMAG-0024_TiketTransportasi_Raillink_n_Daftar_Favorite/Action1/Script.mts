...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0024_TiketTransportasi_Raillink_n_Daftar_Favorite.xlsx", "SMAG-0024")
Call spGetDatatable()

Call fnRunningIterator()
Call spReportInitiate()
Call spAddScenario(dt_TCID, dt_TestScenarioDesc, dt_ScenarioDesc, dt_ExpectedResult, Array("Automation Testing : " & "BAYAR & BELI Tiket Transportasi Railink & Daftar Favorite"))
...
Call Open_MAgen()
Call Goto_Pay_Railink()
Call Input_PayCode(dt_TCID, dt_PayCode)
If dt_TCID = "MAG0024-006" Then
	Call Verify_Fail()
Else
	Call Input_Pass(dt_TCID, dt_PinTrx)
End If
	
If dt_TCID = "MAG0024-001" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0024-004" or dt_TCID = "MAG0024-005" or dt_TCID = "MAG0024-007" Then
	Call Verify_Fail()
'	If dt_TCID = "MAG0024-006" Then
