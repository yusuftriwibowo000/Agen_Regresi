...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0006_Atur_Menu_Favorit.xlsx", "SMAG-0006")
Call spGetDatatable()
...
If dt_TCID = "MAG0006-001" Then
	Call Open_MAgen()
	Call Atur_Menu()
ElseIf dt_TCID = "MAG0006-002" Then
	Call Open_MAgen()
	Call Update_List()
End If
Call Verify_Success()
...
Sub spLoadLibrary()
	...
	Call RepositoriesCollection.Add(LibRepo & "RP_KeagenanMobile_Login.tsr")
   	...
   	REM ---- Menu Favorit Keagenan Mobile Library
	LoadFunctionLibrary (LibPathKeagenanMobile & "Lib_KeagenanMobile_AturMenuFav.qfl")
	Call RepositoriesCollection.Add(LibRepo & "RP_KeagenanMobile_AturMenuFav.tsr")
	
	REM ---- Info Agen Keagenan Mobile Library
	Call RepositoriesCollection.Add(LibRepo & "RP_KeagenanMobile_InformasiAgen.tsr")
End Sub
