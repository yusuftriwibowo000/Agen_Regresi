...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG0050_Transvision.xlsx", "SMAG-050")
Call spGetDatatable()
...
Call Open_MAgen()
Call Goto_Transvision()

If dt_TCID = "MAG0050-003" Then
	Call Choice_Fav()
Else
	Call Input_Baru(dt_TCID, dt_PayCode, dt_SaveName)
End If

If dt_TCID = "MAG0050-006" or dt_TCID = "MAG0050-007" Then
	Call Verify_Fail()
Else
	Call Input_Pass(dt_TCID, dt_PinTrx)
End If

If dt_TCID = "MAG0050-001" or dt_TCID = "MAG0050-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0050-004" or dt_TCID = "MAG0050-005" Then
	Call Verify_Fail()
ElseIf dt_TCID = "MAG0050-002" Then
