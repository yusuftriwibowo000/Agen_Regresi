...
Dim dt_NoKartuKredit, dt_PinTrx, dt_Nominal, dt_SaveName
Dim dt_Username, dt_Password

REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0020_Kartu_Kredit_BNI_n_Daftar_Favorit.xlsx", "SMAG-0020")
Call spGetDatatable()
...
Call Open_MAgen()
Call Goto_MenuBayarCC()
If dt_TCID = "MAG0020-001" Then
	Call Input_Baru(dt_TCID, dt_NoKartuKredit, dt_SaveName)
	Call Input_Pass(dt_TCID, dt_PinTrx, dt_Nominal)
	Call Verify_Success()
ElseIf dt_TCID = "MAG0020-002" Then
	Call Input_Baru(dt_TCID, dt_NoKartuKredit, dt_SaveName)
	Call Input_Pass(dt_TCID, dt_PinTrx, dt_Nominal)
	Call Verify_Success_Save()
ElseIf dt_TCID = "MAG0020-003" Then
	Call Choice_Fav()
	Call Input_Pass(dt_TCID, dt_PinTrx, dt_Nominal)
	Call Verify_Success()
ElseIf dt_TCID = "MAG0020-004" or dt_TCID = "MAG0020-005" Then
	Call Input_Baru(dt_TCID, dt_NoKartuKredit, dt_SaveName)
	Call Input_Pass(dt_TCID, dt_PinTrx, dt_Nominal)
	Call Verify_Fail()
ElseIf dt_TCID = "MAG0020-006" Then
	Call Input_Baru(dt_TCID, dt_NoKartuKredit, dt_SaveName)
	Call Verify_Fail()
End If
...
Sub spLoadLibrary()
	...
	LoadFunctionLibrary (LibPathKeagenanMobile & "Lib_KeagenanMobile_KartuKredit.qfl")
	Call RepositoriesCollection.Add(LibRepo & "RP_KeagenanMobile_KartuKredit.tsr")
End Sub
...
Sub spGetDatatable()
	...
	Rem --------- Paket Data
	dt_NoKartuKredit	= DataTable.Value("NO_CC", dtLocalSheet)
