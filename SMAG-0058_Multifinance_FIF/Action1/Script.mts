...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0058_Multifinance_FIF.xlsx", "SMAG-0058")
Call spGetDatatable()
...
If dt_TCID = "MAG0058-003" or dt_TCID = "MAG0058-007"Then 
	Call Choice_Fav_FIF()
Else
	Call Input_Baru_Multifinance_FIF(dt_TCID, dt_NoKontrak, dt_SaveName)
End If

If dt_TCID = "MAG0058-007" or dt_TCID = "MAG0058-008" Then
	Call Verify_Fail()
Else
	Call Input_Pass(dt_TCID, dt_PinTrx)
End If

If dt_TCID = "MAG0058-001" or dt_TCID = "MAG0058-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0058-002" Then
	Call Verify_Success_Save()
ElseIf dt_TCID = "MAG0058-004" Then
	Call Verify_Fail_Password_Kosong()
ElseIf dt_TCID = "MAG0058-005" or dt_TCID = "MAG0058-009" Then
	Call Verify_Fail()
End If
