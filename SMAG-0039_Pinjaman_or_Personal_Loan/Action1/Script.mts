REM -- Automation Personal Loan
Dim dt_TCID, dt_TestScenarioDesc, dt_ScenarioDesc, dt_ExpectedResult
Dim dt_NoCC, dt_Nominal, dt_PinTrx, dt_SaveName
Dim dt_Username, dt_Password

REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0039_Pinjaman_Personal_Loan.xlsx", "SMAG-0039")
Call spGetDatatable()
...
Call Open_MAgen()
Call Goto_PersonalLoan()

If dt_TCID = "MAG0039-003" Then 
	Call Choice_Fav(dt_TCID)
	Call Input_Nominal(dt_TCID, dt_Nominal)
Else
	Call Input_Baru(dt_TCID, dt_NoCC, dt_SaveName)
	Call Input_Nominal(dt_TCID, dt_Nominal)
End If
'
...
If dt_TCID = "MAG0039-001" or dt_TCID = "MAG0039-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0039-002" Then
...
Sub spLoadLibrary()
	...
	LoadFunctionLibrary (LibPathKeagenanMobile & "Lib_KeagenanMobile_PersonalLoan.qfl")
	Call RepositoriesCollection.Add(LibRepo & "RP_KeagenanMobile_PersonalLoan.tsr")
End Sub
