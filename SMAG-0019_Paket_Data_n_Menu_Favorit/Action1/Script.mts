...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0019_Paket_Data_n_Menu_Favorit.xlsx", "SMAG-0019")
Call spGetDatatable()
...
Call Open_MAgen()
Call Goto_MenuBayar()
If dt_TCID = "MAG0019-001" or dt_TCID = "MAG0019-002" or dt_TCID = "MAG0019-003" or dt_TCID = "MAG0019-004" Then
	Call Input_Baru(dt_TCID, dt_NoHp, dt_SaveName)
	Call Goto_PaketData()
	Call Pilih_PaketData(dt_TCID)
	Call Input_Pass(dt_TCID, dt_PinTrx)
	Call Verify_Success()
ElseIf dt_TCID = "MAG0019-005" Then
	Call Input_Baru(dt_TCID, dt_NoHp, dt_SaveName)
	Call Goto_PaketData()
	Call Pilih_PaketData(dt_TCID)
	Call Input_Pass(dt_TCID, dt_PinTrx)
...
ElseIf dt_TCID = "MAG0019-006" Then
	Call Choice_Fav()
	Call Goto_PaketData()
	Call Pilih_PaketData(dt_TCID)
	Call Input_Pass(dt_TCID, dt_PinTrx)
'	Call Back_Wrong_Pin()
	Call Verify_Success()
ElseIf dt_TCID = "MAG0019-008" Then
	Call Input_Baru(dt_TCID, dt_NoHp, dt_SaveName)
	Call Goto_PaketData()
	Call Verify_Fail()
ElseIf dt_TCID = "MAG0019-007" or dt_TCID = "MAG0019-009" or dt_TCID = "MAG0019-011" Then
	Call Input_Baru(dt_TCID, dt_NoHp, dt_SaveName)
	Call Goto_PaketData()
	Call Pilih_PaketData(dt_TCID)
	Call Input_Pass(dt_TCID, dt_PinTrx)
	Call Verify_Fail()
ElseIf dt_TCID = "MAG0019-010" Then
	Call Input_Baru(dt_TCID, dt_NoHp, dt_SaveName)
	Call Goto_PaketData()
	Call Pilih_PaketData(dt_TCID)
	Call Input_Pass(dt_TCID, dt_PinTrx)
...
Sub spLoadLibrary()
	...
	LoadFunctionLibrary (LibPathKeagenanMobile & "Lib_KeagenanMobile_PaketData.qfl")
	Call RepositoriesCollection.Add(LibRepo & "RP_KeagenanMobile_PaketData.tsr")
End Sub
