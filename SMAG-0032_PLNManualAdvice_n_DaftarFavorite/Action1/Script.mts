...
Dim dt_IDPelanggan, dt_PinTrx, dt_SaveName, dt_Ref
Dim dt_Username, dt_Password

REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG0032_PLNManualAdvice_n_DaftarFavorite.xlsx", "SMAG-0032")
Call spGetDatatable()
...
Call Open_MAgen()
Call Goto_ManualAdvice()

If dt_TCID = "MAG0032-003" Then
	Call Choice_Fav()
	Call Input_Ref(dt_Ref)
	Call Input_Pass(dt_TCID, dt_PinTrx)
Else
	Call Input_Baru(dt_TCID, dt_IDPelanggan, dt_SaveName, dt_Ref, dt_PinTrx)
End If

If dt_TCID = "MAG0032-001" or dt_TCID = "MAG0032-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0032-004" or dt_TCID = "MAG0032-005" Then
	Call Verify_Fail()
ElseIf dt_TCID = "MAG0032-002" Then
...
Sub spLoadLibrary()
	...
	LoadFunctionLibrary (LibPathKeagenanMobile & "Lib_KeagenanMobile_PLNManualAdvice.qfl")
...
Sub spGetDatatable()
	...
	dt_Ref 				= DataTable.Value("NO_REF", dtLocalSheet)
