...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0042_Login_Aktivasi_Agen.xlsx", "SMAG-0042")
Call spGetDatatable()
...
If dt_TCID = "MAG0042-001" Then
	Call Verivy_OpenForNewOSVersion()
ElseIf dt_TCID = "MAG0042-002" Then
	Call Verivy_OpenForNewOSVersionWithOTP()
End If
...
Sub spLoadLibrary()
	...
	REM ---- Login Aktivasi Keagenan Mobile Library
