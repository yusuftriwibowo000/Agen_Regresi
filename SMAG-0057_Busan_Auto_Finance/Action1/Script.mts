...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0057_Busan_Auto_Finance.xlsx", "SMAG-0057")
Call spGetDatatable()
...
If dt_TCID = "MAG0057-003" Then 
	Call Choice_Fav()
Else
	Call Input_Baru_Busan_Auto_finance(dt_TCID, dt_NoKontrak, dt_SaveName)
End If
...
If dt_TCID = "MAG0057-001" or dt_TCID = "MAG0057-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0057-002" Then
	Call Verify_Success_Save()
ElseIf dt_TCID = "MAG0057-004" Then
	Call Verify_Fail_Password_Kosong()
ElseIf dt_TCID = "MAG0057-005" or dt_TCID = "MAG0057-009" Then
	Call Verify_Fail()
End If
