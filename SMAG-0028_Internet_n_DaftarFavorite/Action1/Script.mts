...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG0028_Internet_n_DaftarFavorite.xlsx", "SMAG-0028")
Call spGetDatatable()
...
Call Open_MAgen()
Call Goto_Indihome()
If dt_TCID = "MAG0028-003" Then
	Call Choice_Fav()
Else
	Call Input_Baru(dt_TCID, dt_PayCode, dt_SaveName)
End If

If dt_TCID = "MAG0028-006" or dt_TCID = "MAG0028-007" Then
	Call Verify_Fail()
Else
	Call Input_Pass(dt_TCID, dt_PinTrx)
End If

If dt_TCID = "MAG0028-001" or dt_TCID = "MAG0028-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0028-004" or dt_TCID = "MAG0028-005"  or dt_TCID = "MAG0028-008" Then
	Call Verify_Fail()
ElseIf dt_TCID = "MAG0028-002" Then
