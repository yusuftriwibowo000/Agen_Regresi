...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0061_Multifinance_SMS_Finance.xlsx", "SMAG-0061")
Call spGetDatatable()
...
If dt_TCID = "MAG0061-003" or dt_TCID = "MAG0061-007" Then 
	Call Choice_Fav_SMS()
Else
	Call Input_Baru_Multifinance_SMS_Finance(dt_TCID, dt_NoKontrak, dt_SaveName)
End If

If dt_TCID = "MAG0061-007" or dt_TCID = "MAG0061-008"  Then
	Call Verify_Fail()
Else
	Call Input_Pass(dt_TCID, dt_PinTrx)
End If

If dt_TCID = "MAG0061-001" or dt_TCID = "MAG0061-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0061-002" Then
	Call Verify_Success_Save()
ElseIf dt_TCID = "MAG0061-004" Then
	Call Verify_Fail_Password_Kosong()
ElseIf dt_TCID = "MAG0061-005" or dt_TCID = "MAG0061-009" Then
	Call Verify_Fail()
End If
