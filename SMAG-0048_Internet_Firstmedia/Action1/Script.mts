...
If dt_TCID = "MAG0048-006" or dt_TCID = "MAG0048-007" or dt_TCID = "MAG0048-008" Then
	Call Verify_Fail()
Else
	Call Input_Pass(dt_TCID, dt_PinTrx)
End If

If dt_TCID = "MAG0048-001" or dt_TCID = "MAG0048-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0048-004" or dt_TCID = "MAG0048-005" Then
	Call Verify_Fail()
