...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0025_TiketTransportasi_KAI_n_Daftar_Favorite.xlsx", "SMAG-0025")
Call spGetDatatable()

Call fnRunningIterator()
Call spReportInitiate()
Call spAddScenario(dt_TCID, dt_TestScenarioDesc, dt_ScenarioDesc, dt_ExpectedResult, Array("Automation Testing : " & "BAYAR & BELI Tiket Transportasi Kereta Api & Daftar Favorite"))
...
If dt_TCID = "MAG0025-001"  or dt_TCID = "MAG0025-002" or dt_TCID = "MAG0025-003"  or dt_TCID = "MAG0025-006" Then
'	MsgBox ("tunggu service mati")
	Call Input_Pass(dt_TCID, dt_PinTrx)
	
	If dt_TCID = "MAG0025-001" Then
		Call Verify_Success()
	ElseIf dt_TCID = "MAG0025-002" or dt_TCID = "MAG0025-003" or dt_TCID = "MAG0024-006" Then
	MsgBox "tekan lagi"
		Call Verify_Fail()
	'	Call Back_Wrong_Pin()
	End If

ElseIf dt_TCID = "MAG0025-004" or dt_TCID = "MAG0024-005" Then
	Call Back_Wrong_PayCode()
End If
...
'ElseIf dt_TCID = "MAG0025-002" or dt_TCID = "MAG0025-003" or dt_TCID = "MAG0024-006" Then
'	Call Verify_Fail()
'	If dt_TCID = "MAG0025-004" or dt_TCID = "MAG0024-005" Then
'		Call Back_Wrong_PayCode()
'	End If
''	Call Back_Wrong_Pin()
' Call logout()
