...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0018_Lokasi_Agen.xlsx", "SMAG-0018")
Call spGetDatatable()
...
Call Goto_Informasi()
Call Goto_LokasiAgen()
Call Verivy_LokasiAgen()
...
Sub spLoadLibrary()
	...
	LoadFunctionLibrary (LibPathKeagenanMobile & "Lib_KeagenanMobile_LokasiAgen.qfl")
	Call RepositoriesCollection.Add(LibRepo & "RP_KeagenanMobile_LokasiAgen.tsr")
End Sub
