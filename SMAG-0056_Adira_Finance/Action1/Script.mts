...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0056_Adira_Finance.xlsx", "SMAG-0056")
Call spGetDatatable()
...
If dt_TCID = "MAG0056-003" or dt_TCID = "MAG0056-007" Then 
	Call Choice_Fav_Adira()
Else
	Call Input_Baru_Adira_Finance(dt_TCID, dt_NoKontrak, dt_SaveName)
End If

If dt_TCID = "MAG0056-007" or dt_TCID = "MAG0056-008" Then
	Call Verify_Fail()
Else
	Call Input_Pass(dt_TCID, dt_PinTrx)
End If

If dt_TCID = "MAG0056-001" or dt_TCID = "MAG0056-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0056-002" Then
	Call Verify_Success_Save()
ElseIf dt_TCID = "MAG0056-004" Then
	Call Verify_Fail_Password_Kosong()
ElseIf dt_TCID = "MAG0056-005" or dt_TCID = "MAG0056-009" Then
	Call Verify_Fail()
End If
