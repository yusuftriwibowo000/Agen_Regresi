...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG0049_MNC_Vision.xlsx", "SMAG-0049")
Call spGetDatatable()
...
Call Open_MAgen()
Call Goto_MNC_Vision()

If dt_TCID = "MAG0049-003" Then
	Call Choice_Fav(dt_TCID)
Else
	Call Input_Baru(dt_TCID, dt_PayCode, dt_SaveName)
End If

If dt_TCID = "MAG0049-006" or dt_TCID = "MAG0049-007" Then
	Call Verify_Fail()
Else
	Call Input_Pass(dt_TCID, dt_PinTrx)
End If

If dt_TCID = "MAG0049-001" or dt_TCID = "MAG0049-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0049-004" or dt_TCID = "MAG0049-005" Then
	Call Verify_Fail()
ElseIf dt_TCID = "MAG0049-002" Then
