REM -- Bayar dan Beli Kartu Kredit non BNI
Dim dt_TCID, dt_TestScenarioDesc, dt_ScenarioDesc, dt_ExpectedResult
Dim dt_NoCC, dt_PinTrx, dt_SaveName, dt_Nonimal
Dim dt_Username, dt_Password

REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG0029_KartuKreditNonBNI_n_DaftarFavorite.xlsx", "SMAG-0029")
Call spGetDatatable()

Call fnRunningIterator()
Call spReportInitiate()
Call spAddScenario(dt_TCID, dt_TestScenarioDesc, dt_ScenarioDesc, dt_ExpectedResult, Array("Automation Testing : " & "BAYAR & BELI Kartu Kredit Non BNI & Daftar Favorite"))

REM ------- Keagenan Mobile
Call Login(dt_Username, dt_Password)
Call Open_MAgen()
Call Goto_CCNonBNI()
If dt_TCID = "MAG0029-004" Then
	Call Choice_Fav()
Else
	Call Input_Baru(dt_TCID, dt_NoCC, dt_Nonimal, dt_SaveName)
End If

Call Input_Pass(dt_TCID, dt_PinTrx)

If dt_TCID = "MAG0029-001" or dt_TCID = "MAG0029-002" or dt_TCID = "MAG0029-004" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0029-005" or dt_TCID = "MAG0029-006" or dt_TCID = "MAG0029-007" Then
	Call Verify_Fail()
ElseIf dt_TCID = "MAG0029-003" Then
...
Sub spLoadLibrary()
	...
	LoadFunctionLibrary (LibPathKeagenanMobile & "Lib_KeagenanMobile_KartuKredit_NonBNI.qfl")
	Call RepositoriesCollection.Add(LibRepo & "RP_KeagenanMobile_KartuKredit_NonBNI.tsr")
End Sub
