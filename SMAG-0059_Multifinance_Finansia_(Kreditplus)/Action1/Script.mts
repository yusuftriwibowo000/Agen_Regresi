...
REM -------------- Call Function
Call spLoadLibrary()
Call spInitiateData("KeagenanMobile_Lib_Report.xlsx", "SMAG-0059_Multifinance_Finansia_(Kreditplus).xlsx", "SMAG-0059")
Call spGetDatatable()
...
If dt_TCID = "MAG0059-003" Then 
	Call Choice_Fav()
Else
	Call Input_Baru_Multifinance_Finansia_Krediplus(dt_TCID, dt_NoKontrak, dt_SaveName)
End If

If dt_TCID = "MAG0059-007" or dt_TCID = "MAG0059-008" Then
	Call Verify_Fail()
Else
	Call Input_Pass(dt_TCID, dt_PinTrx)
End If

If dt_TCID = "MAG0059-001" or dt_TCID = "MAG0059-003" Then
	Call Verify_Success()
ElseIf dt_TCID = "MAG0059-002" Then
	Call Verify_Success_Save()
ElseIf dt_TCID = "MAG0059-004" Then
	Call Verify_Fail_Password_Kosong()
ElseIf dt_TCID = "MAG0059-005" or dt_TCID = "MAG0059-009" Then
	Call Verify_Fail()
End If
